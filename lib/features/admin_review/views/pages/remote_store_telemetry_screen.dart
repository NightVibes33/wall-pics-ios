...
const String _kTelemetryFileName = 'remote_store_telemetry.ndjson';

@RoutePage()
class RemoteStoreTelemetryScreen extends StatefulWidget {
  const RemoteStoreTelemetryScreen({super.key});

  @override
  State<RemoteStoreTelemetryScreen> createState() => _RemoteStoreTelemetryScreenState();
}

class _RemoteStoreTelemetryScreenState extends State<RemoteStoreTelemetryScreen> {
  String? _error;
  bool _loading = true;
  int _totalEvents = 0;
  int _docReads = 0;
  ...
  Widget build(BuildContext context) {
    if (!app_state.isAdminUser()) {
      return Scaffold(
        appBar: AppBar(title: const Text('RemoteStore telemetry')),
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('RemoteStore telemetry'),
        actions: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    if (_rawContent.isEmpty)
                      Padding(
                        ...
                        child: Text(
                          'No telemetry recorded yet. Use the app to generate RemoteStore events.',
