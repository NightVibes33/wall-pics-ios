...
Future<void> createRecord(
  ...
  if (!app_state.prismUser.premium) {
    ...
    if (app_state.prismUser.id.trim().isNotEmpty) {
      remoteStoreClient.updateDoc(RemoteCollections.usersV2, app_state.prismUser.id, {
  ...
  await remoteStoreClient.addDoc(RemoteCollections.walls, {
...
Future<void> createSetup(
  ...
  await remoteStoreClient.addDoc(RemoteCollections.setups, {
    'by': app_state.prismUser.name,
    'email': app_state.prismUser.email,
    'userPhoto': app_state.prismUser.profilePhoto,
    'id': id,
...
Future<void> createDraftSetup(
  ...
  await remoteStoreClient.setDoc(RemoteCollections.draftSetups, id!, {
    'by': app_state.prismUser.name,
    'email': app_state.prismUser.email,
    'userPhoto': app_state.prismUser.profilePhoto,
    'id': id,
