...
@RemoteStoreStringConverter() String get id;@RemoteStoreStringConverter() String get name;@RemoteStoreStringConverter() String get email;@RemoteStoreStringConverter() String get username;@RemoteStoreStringConverter() String get profilePhoto;@RemoteStoreStringConverter() String get bio;@RemoteStoreStringListConverter() List<String> get followers;@RemoteStoreStringListConverter() List<String> get following;@RemoteStoreStringMapConverter() Map<String, String> get links; bool get premium;@RemoteStoreStringConverter() String get coverPhoto;
...
@useResult
$Res call({
@RemoteStoreStringConverter() String id,@RemoteStoreStringConverter() String name,@RemoteStoreStringConverter() String email,@RemoteStoreStringConverter() String username,@RemoteStoreStringConverter() String profilePhoto,@RemoteStoreStringConverter() String bio,@RemoteStoreStringListConverter() List<String> followers,@RemoteStoreStringListConverter() List<String> following,@RemoteStoreStringMapConverter() Map<String, String> links, bool premium,@RemoteStoreStringConverter() String coverPhoto
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String name, @RemoteStoreStringConverter()  String email, @RemoteStoreStringConverter()  String username, @RemoteStoreStringConverter()  String profilePhoto, @RemoteStoreStringConverter()  String bio, @RemoteStoreStringListConverter()  List<String> followers, @RemoteStoreStringListConverter()  List<String> following, @RemoteStoreStringMapConverter()  Map<String, String> links,  bool premium, @RemoteStoreStringConverter()  String coverPhoto)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PublicUserDocDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String name, @RemoteStoreStringConverter()  String email, @RemoteStoreStringConverter()  String username, @RemoteStoreStringConverter()  String profilePhoto, @RemoteStoreStringConverter()  String bio, @RemoteStoreStringListConverter()  List<String> followers, @RemoteStoreStringListConverter()  List<String> following, @RemoteStoreStringMapConverter()  Map<String, String> links,  bool premium, @RemoteStoreStringConverter()  String coverPhoto)  $default,) {final _that = this;
switch (_that) {
case _PublicUserDocDto():
return $default(_that.id,_that.name,_that.email,_that.username,_that.profilePhoto,_that.bio,_that.followers,_that.following,_that.links,_that.premium,_that.coverPhoto);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String name, @RemoteStoreStringConverter()  String email, @RemoteStoreStringConverter()  String username, @RemoteStoreStringConverter()  String profilePhoto, @RemoteStoreStringConverter()  String bio, @RemoteStoreStringListConverter()  List<String> followers, @RemoteStoreStringListConverter()  List<String> following, @RemoteStoreStringMapConverter()  Map<String, String> links,  bool premium, @RemoteStoreStringConverter()  String coverPhoto)?  $default,) {final _that = this;
switch (_that) {
case _PublicUserDocDto() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.username,_that.profilePhoto,_that.bio,_that.followers,_that.following,_that.links,_that.premium,_that.coverPhoto);case _:
  return null;
...
class _PublicUserDocDto implements PublicUserDocDto {
  const _PublicUserDocDto({@RemoteStoreStringConverter() this.id = '', @RemoteStoreStringConverter() this.name = '', @RemoteStoreStringConverter() this.email = '', @RemoteStoreStringConverter() this.username = '', @RemoteStoreStringConverter() this.profilePhoto = '', @RemoteStoreStringConverter() this.bio = '', @RemoteStoreStringListConverter() final  List<String> followers = const <String>[], @RemoteStoreStringListConverter() final  List<String> following = const <String>[], @RemoteStoreStringMapConverter() final  Map<String, String> links = const <String, String>{}, this.premium = false, @RemoteStoreStringConverter() this.coverPhoto = ''}): _followers = followers,_following = following,_links = links;
...
@override@JsonKey()@RemoteStoreStringConverter() final  String username;
@override@JsonKey()@RemoteStoreStringConverter() final  String profilePhoto;
@override@JsonKey()@RemoteStoreStringConverter() final  String bio;
 final  List<String> _followers;
@override@JsonKey()@RemoteStoreStringListConverter() List<String> get followers {
...
@override@JsonKey()@RemoteStoreStringListConverter() List<String> get following {
...
@override@JsonKey()@RemoteStoreStringMapConverter() Map<String, String> get links {
...
@override@JsonKey()@RemoteStoreStringConverter() final  String coverPhoto;
