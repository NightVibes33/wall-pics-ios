...
@RemoteStoreStringConverter() String get id;@RemoteStoreStringConverter() String get by;@RemoteStoreStringConverter() String get desc;@RemoteStoreStringConverter() String get size;@RemoteStoreStringConverter() String get resolution;@RemoteStoreStringConverter() String get email;@JsonKey(name: 'wallpaper_provider')@RemoteStoreStringConverter() String get wallpaperProvider;@JsonKey(name: 'wallpaper_thumb')@RemoteStoreStringConverter() String get wallpaperThumb;@JsonKey(name: 'wallpaper_url')@RemoteStoreStringConverter() String get wallpaperUrl;@RemoteStoreStringListConverter() List<String> get collections;@RemoteStoreDateTimeConverter() DateTime? get createdAt; bool get review;
...
@useResult
$Res call({
@RemoteStoreStringConverter() String id,@RemoteStoreStringConverter() String by,@RemoteStoreStringConverter() String desc,@RemoteStoreStringConverter() String size,@RemoteStoreStringConverter() String resolution,@RemoteStoreStringConverter() String email,@JsonKey(name: 'wallpaper_provider')@RemoteStoreStringConverter() String wallpaperProvider,@JsonKey(name: 'wallpaper_thumb')@RemoteStoreStringConverter() String wallpaperThumb,@JsonKey(name: 'wallpaper_url')@RemoteStoreStringConverter() String wallpaperUrl,@RemoteStoreStringListConverter() List<String> collections,@RemoteStoreDateTimeConverter() DateTime? createdAt, bool review
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String by, @RemoteStoreStringConverter()  String desc, @RemoteStoreStringConverter()  String size, @RemoteStoreStringConverter()  String resolution, @RemoteStoreStringConverter()  String email, @JsonKey(name: 'wallpaper_provider')@RemoteStoreStringConverter()  String wallpaperProvider, @JsonKey(name: 'wallpaper_thumb')@RemoteStoreStringConverter()  String wallpaperThumb, @JsonKey(name: 'wallpaper_url')@RemoteStoreStringConverter()  String wallpaperUrl, @RemoteStoreStringListConverter()  List<String> collections, @RemoteStoreDateTimeConverter()  DateTime? createdAt,  bool review)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WallDocDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String by, @RemoteStoreStringConverter()  String desc, @RemoteStoreStringConverter()  String size, @RemoteStoreStringConverter()  String resolution, @RemoteStoreStringConverter()  String email, @JsonKey(name: 'wallpaper_provider')@RemoteStoreStringConverter()  String wallpaperProvider, @JsonKey(name: 'wallpaper_thumb')@RemoteStoreStringConverter()  String wallpaperThumb, @JsonKey(name: 'wallpaper_url')@RemoteStoreStringConverter()  String wallpaperUrl, @RemoteStoreStringListConverter()  List<String> collections, @RemoteStoreDateTimeConverter()  DateTime? createdAt,  bool review)  $default,) {final _that = this;
switch (_that) {
case _WallDocDto():
return $default(_that.id,_that.by,_that.desc,_that.size,_that.resolution,_that.email,_that.wallpaperProvider,_that.wallpaperThumb,_that.wallpaperUrl,_that.collections,_that.createdAt,_that.review);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String by, @RemoteStoreStringConverter()  String desc, @RemoteStoreStringConverter()  String size, @RemoteStoreStringConverter()  String resolution, @RemoteStoreStringConverter()  String email, @JsonKey(name: 'wallpaper_provider')@RemoteStoreStringConverter()  String wallpaperProvider, @JsonKey(name: 'wallpaper_thumb')@RemoteStoreStringConverter()  String wallpaperThumb, @JsonKey(name: 'wallpaper_url')@RemoteStoreStringConverter()  String wallpaperUrl, @RemoteStoreStringListConverter()  List<String> collections, @RemoteStoreDateTimeConverter()  DateTime? createdAt,  bool review)?  $default,) {final _that = this;
switch (_that) {
case _WallDocDto() when $default != null:
return $default(_that.id,_that.by,_that.desc,_that.size,_that.resolution,_that.email,_that.wallpaperProvider,_that.wallpaperThumb,_that.wallpaperUrl,_that.collections,_that.createdAt,_that.review);case _:
  return null;
...
class _WallDocDto implements WallDocDto {
  const _WallDocDto({@RemoteStoreStringConverter() this.id = '', @RemoteStoreStringConverter() this.by = '', @RemoteStoreStringConverter() this.desc = '', @RemoteStoreStringConverter() this.size = '', @RemoteStoreStringConverter() this.resolution = '', @RemoteStoreStringConverter() this.email = '', @JsonKey(name: 'wallpaper_provider')@RemoteStoreStringConverter() this.wallpaperProvider = '', @JsonKey(name: 'wallpaper_thumb')@RemoteStoreStringConverter() this.wallpaperThumb = '', @JsonKey(name: 'wallpaper_url')@RemoteStoreStringConverter() this.wallpaperUrl = '', @RemoteStoreStringListConverter() final  List<String> collections = const <String>[], @RemoteStoreDateTimeConverter() this.createdAt, this.review = false}): _collections = collections;
  factory _WallDocDto.fromJson(Map<String, dynamic> json) => _$WallDocDtoFromJson(json);

@override@JsonKey()@RemoteStoreStringConverter() final  String id;
@override@JsonKey()@RemoteStoreStringConverter() final  String by;
@override@JsonKey()@RemoteStoreStringConverter() final  String desc;
@override@JsonKey()@RemoteStoreStringConverter() final  String size;
@override@JsonKey()@RemoteStoreStringConverter() final  String resolution;
@override@JsonKey()@RemoteStoreStringConverter() final  String email;
@override@JsonKey(name: 'wallpaper_provider')@RemoteStoreStringConverter() final  String wallpaperProvider;
@override@JsonKey(name: 'wallpaper_thumb')@RemoteStoreStringConverter() final  String wallpaperThumb;
@override@JsonKey(name: 'wallpaper_url')@RemoteStoreStringConverter() final  String wallpaperUrl;
 final  List<String> _collections;
@override@JsonKey()@RemoteStoreStringListConverter() List<String> get collections {
  if (_collections is EqualUnmodifiableListView) return _collections;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_collections);
}

@override@RemoteStoreDateTimeConverter() final  DateTime? createdAt;
...
@RemoteStoreStringConverter() String get id;@RemoteStoreStringConverter() String get provider;@RemoteStoreStringConverter() String get url;@RemoteStoreStringConverter() String get thumb;@RemoteStoreStringConverter() String get category;@RemoteStoreStringConverter() String get views;@RemoteStoreStringConverter() String get resolution;@RemoteStoreStringConverter() String get fav;@RemoteStoreStringConverter() String get size;@RemoteStoreStringConverter() String get photographer;@RemoteStoreStringListConverter() List<String> get collections;@RemoteStoreDateTimeConverter() DateTime? get createdAt;
...
@useResult
$Res call({
@RemoteStoreStringConverter() String id,@RemoteStoreStringConverter() String provider,@RemoteStoreStringConverter() String url,@RemoteStoreStringConverter() String thumb,@RemoteStoreStringConverter() String category,@RemoteStoreStringConverter() String views,@RemoteStoreStringConverter() String resolution,@RemoteStoreStringConverter() String fav,@RemoteStoreStringConverter() String size,@RemoteStoreStringConverter() String photographer,@RemoteStoreStringListConverter() List<String> collections,@RemoteStoreDateTimeConverter() DateTime? createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String provider, @RemoteStoreStringConverter()  String url, @RemoteStoreStringConverter()  String thumb, @RemoteStoreStringConverter()  String category, @RemoteStoreStringConverter()  String views, @RemoteStoreStringConverter()  String resolution, @RemoteStoreStringConverter()  String fav, @RemoteStoreStringConverter()  String size, @RemoteStoreStringConverter()  String photographer, @RemoteStoreStringListConverter()  List<String> collections, @RemoteStoreDateTimeConverter()  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavouriteWallDocDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String provider, @RemoteStoreStringConverter()  String url, @RemoteStoreStringConverter()  String thumb, @RemoteStoreStringConverter()  String category, @RemoteStoreStringConverter()  String views, @RemoteStoreStringConverter()  String resolution, @RemoteStoreStringConverter()  String fav, @RemoteStoreStringConverter()  String size, @RemoteStoreStringConverter()  String photographer, @RemoteStoreStringListConverter()  List<String> collections, @RemoteStoreDateTimeConverter()  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _FavouriteWallDocDto():
return $default(_that.id,_that.provider,_that.url,_that.thumb,_that.category,_that.views,_that.resolution,_that.fav,_that.size,_that.photographer,_that.collections,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@RemoteStoreStringConverter()  String id, @RemoteStoreStringConverter()  String provider, @RemoteStoreStringConverter()  String url, @RemoteStoreStringConverter()  String thumb, @RemoteStoreStringConverter()  String category, @RemoteStoreStringConverter()  String views, @RemoteStoreStringConverter()  String resolution, @RemoteStoreStringConverter()  String fav, @RemoteStoreStringConverter()  String size, @RemoteStoreStringConverter()  String photographer, @RemoteStoreStringListConverter()  List<String> collections, @RemoteStoreDateTimeConverter()  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _FavouriteWallDocDto() when $default != null:
return $default(_that.id,_that.provider,_that.url,_that.thumb,_that.category,_that.views,_that.resolution,_that.fav,_that.size,_that.photographer,_that.collections,_that.createdAt);case _:
  return null;
...
class _FavouriteWallDocDto implements FavouriteWallDocDto {
  const _FavouriteWallDocDto({@RemoteStoreStringConverter() this.id = '', @RemoteStoreStringConverter() this.provider = '', @RemoteStoreStringConverter() this.url = '', @RemoteStoreStringConverter() this.thumb = '', @RemoteStoreStringConverter() this.category = '', @RemoteStoreStringConverter() this.views = '', @RemoteStoreStringConverter() this.resolution = '', @RemoteStoreStringConverter() this.fav = '', @RemoteStoreStringConverter() this.size = '', @RemoteStoreStringConverter() this.photographer = '', @RemoteStoreStringListConverter() final  List<String> collections = const <String>[], @RemoteStoreDateTimeConverter() this.createdAt}): _collections = collections;
  factory _FavouriteWallDocDto.fromJson(Map<String, dynamic> json) => _$FavouriteWallDocDtoFromJson(json);

@override@JsonKey()@RemoteStoreStringConverter() final  String id;
@override@JsonKey()@RemoteStoreStringConverter() final  String provider;
@override@JsonKey()@RemoteStoreStringConverter() final  String url;
@override@JsonKey()@RemoteStoreStringConverter() final  String thumb;
@override@JsonKey()@RemoteStoreStringConverter() final  String category;
@override@JsonKey()@RemoteStoreStringConverter() final  String views;
@override@JsonKey()@RemoteStoreStringConverter() final  String resolution;
@override@JsonKey()@RemoteStoreStringConverter() final  String fav;
@override@JsonKey()@RemoteStoreStringConverter() final  String size;
@override@JsonKey()@RemoteStoreStringConverter() final  String photographer;
 final  List<String> _collections;
@override@JsonKey()@RemoteStoreStringListConverter() List<String> get collections {
  if (_collections is EqualUnmodifiableListView) return _collections;
  // ignore: implicit_dynamic_type
